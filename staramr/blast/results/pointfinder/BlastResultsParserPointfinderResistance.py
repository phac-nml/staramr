...
class BlastResultsParserPointfinderResistance(BlastResultsParserPointfinder):
    ...
    def __init__(self, file_blast_map, arg_drug_table, cge_drug_table, blast_database, pid_threshold,
        ...
        :param cge_drug_table: A table mapping the resistance gene to a CGE-predicted drug resistance.
    ...
    def _get_result(self, hit, db_mutation):
        ...
        cge_drug = self._cge_drug_table.get_drug(hit.get_amr_gene_id(), mutation_position)
        print("cge drug")
        print(cge_drug)
