...
class AMRDetectionMLST(unittest.TestCase):
    ...
    def testMLSTResults(self):
        ...
        self.assertEqual(mlst_results['Sequence Type'].iloc[0], '-', msg='Wrong Sequence Type')
        ...
        self.assertEqual(mlst_results['Locus 7'].iloc[0], 'thrA(5,783)', msg='Wrong Locus 7 Result')
